...
import { getRangetxt } from './get';
import formula from './formula';
import func_methods from './func_methods';
import { isdatetime, diff, isdatatype } from './datecontroll';
import { genarate, update } from './format';
import { orderbydata } from './sort';
import { getcellvalue } from './getdata';
import { getObjType, ABCatNum, chatatABC, numFormat, isRealNum, isRealNull, valueIsError,error } from './utils';
...
const functionImplementation = {
    ...
    "AGE_BY_IDCARD": function() {
        ...
        try {
            ...
            if (!luckysheet_function.ISIDCARD.f(UUserCard)) {
                return formula.error.v;
            }

            var birthday = luckysheet_function.BIRTHDAY_BY_IDCARD.f(UUserCard);
        ...
        try {
            ...
            if(getObjType(data) == "array"){
                ...
                if(data.rowl > 1){
                    ...
                    if(0 < str || 0 > str + data.rowl - 1){
                        return formula.error.v;
                    }

                    var cell = data.data[0 - str][0];
                }
                else{
                    var cell = data.data;
                }
    ...
    "LCM": function() {
        ...
        try {
            ...
            for (var i : number, j, n, d, r = 1; (n = o.pop()) !== undefined;) {
                if(n == 0){
                    r = 0;
                }
        ...
        try {
            ...
            function compute(function_num){
                switch(function_num){
                    case 1:    //AVERAGE
                    case 101:
                        return luckysheet_function.AVERAGE.f.apply(luckysheet_function.AVERAGE, arr);
                        break;
                    case 2:    //COUNT
                    case 102:
                        return luckysheet_function.COUNT.f.apply(luckysheet_function.COUNT, arr);
                        break;
                    case 3:    //COUNTA
                    case 103:
                        return luckysheet_function.COUNTA.f.apply(luckysheet_function.COUNTA, arr);
                        break;
                    case 4:    //MAX
                    case 104:
                        return luckysheet_function.MAX.f.apply(luckysheet_function.MAX, arr);
                        break;
                    case 5:    //MIN
                    case 105:
                        return luckysheet_function.MIN.f.apply(luckysheet_function.MIN, arr);
                        break;
                    case 6:    //PRODUCT
                    case 106:
                        return luckysheet_function.PRODUCT.f.apply(luckysheet_function.PRODUCT, arr);
                        break;
                    case 7:    //STDEV
                    case 107:
                        return luckysheet_function.STDEVA.f.apply(luckysheet_function.STDEVA, arr);
                        break;
                    case 8:    //STDEVP
                    case 108:
                        return luckysheet_function.STDEVP.f.apply(luckysheet_function.STDEVP, arr);
                        break;
                    case 9:    //SUM
                    case 109:
                        return luckysheet_function.SUM.f.apply(luckysheet_function.SUM, arr);
                        break;
                    case 10:   //VAR
                    case 110:
                        return luckysheet_function.VAR_S.f.apply(luckysheet_function.VAR_S, arr);
                        break;
                    case 11:   //VARP
                    case 111:
                        return luckysheet_function.VAR_P.f.apply(luckysheet_function.VAR_P, arr);
                        break;
                }
            }
        }
    ...
    "COUNTUNIQUE": function() {
        ...
        try {
            ...
            return luckysheet_function.UNIQUE.f(dataArr);
        }
        catch (e) {
            var err = e;
            err = formula.errorInfo(err);
    ...
    "PERCENTRANK_EXC": function() {
        ...
        try {
            ...
            var uniques = luckysheet_function.UNIQUE.f(ref_n)[0];
    ...
    "TRIMMEAN": function() {
        ...
        try {
            ...
            var trim = luckysheet_function.FLOOR.f(dataArr_n.length * percent, 2) / 2;
    ...
    "Z_TEST": function() {
        ...
        try {
            ...
            //计算
            var n = dataArr_n.length;
            var mean = luckysheet_function.AVERAGE.f.apply(luckysheet_function.AVERAGE, dataArr_n);

            return 1 - luckysheet_function.NORM_S_DIST.f((mean - x) / (sigma / Math.sqrt(n)), "true");
        }
        catch (e) {
            var err = e;
            err = formula.errorInfo(err);
    ...
    "QUARTILE_EXC": function() {
        ...
        try {
            ...
            switch (quart) {
                case 1:
                    return luckysheet_function.PERCENTILE_EXC.f(array, 0.25);
                case 2:
                    return luckysheet_function.PERCENTILE_EXC.f(array, 0.5);
                case 3:
                    return luckysheet_function.PERCENTILE_EXC.f(array, 0.75);
            }
        }
        catch (e) {
            var err = e;
    ...
    "QUARTILE_INC": function() {
        ...
        try {
            ...
            switch (quart) {
                ...
                case 1:
                    return luckysheet_function.PERCENTILE_INC.f(array, 0.25);
                case 2:
                    return luckysheet_function.PERCENTILE_INC.f(array, 0.5);
                case 3:
                    return luckysheet_function.PERCENTILE_INC.f(array, 0.75);
                case 4:
    ...
    "RSQ": function() {
        ...
        try {
            ...
            return Math.pow(luckysheet_function.PEARSON.f(data_y, data_x), 2);
        }
        catch (e) {
            var err = e;
            err = formula.errorInfo(err);
    ...
    "T_TEST": function() {
        ...
        try {
            ...
            if(tails == 1){
                var result = luckysheet_function.T_DIST_RT.f(t, df);
            }
            else if(tails == 2){
                var result = luckysheet_function.T_DIST_2T.f(t, df);
            }
    ...
    "INDIRECT": function() {
        ...
        try {
            ...
            let luckysheetfile = global['sheet']
            let index = global['index']
            let currentSheet = luckysheetfile;
            let sheetdata = currentSheet.data;
            // sheetdata = global['sheet'].data;
            ...
            if(formula.iscelldata(ref_text)){
                ...
                if (formula.execFunctionGlobalData != null) {
                    let ef = formula.execFunctionGlobalData[row+"_"+col+"_"+global['index']];
                    if(ef!=null){
                        value = ef.v;
                    }
                }
    ...
    "OFFSET": function() {
        ...
        try {
            ...
            let luckysheetfile = global['sheet'];
            let index = global['index'];
            let sheetdata = luckysheetfile.data;
            ...
            for(var r = cellRow0; r <= cellRow1; r++){
                ...
                for(var c = cellCol0; c <= cellCol1; c++){
                    if(formula.execFunctionGlobalData != null && formula.execFunctionGlobalData[r+"_"+c+"_"+global['index']]!=null){
                        let ef = formula.execFunctionGlobalData[r+"_"+c+"_"+global['index']];
                        if(ef!=null){
                            rowArr.push(ef.v);
                        }
                        else{
            ...
            let retAll= {
                "sheetName": sheetName,
                "startCell": getRangetxt(global['index'], {
                ...
                for (var i = 0; i < range.length; i++) {
                    ...
                    if(rangeNow.length != 0){
                        ...
                        if(index == (rangeNow.length -1)){
                            ...
                            if(arguments[2]){
                                var i : number = range.indexOf(mat);//改成数组
                                result = range2[i];
                            }else{
                                result = mat;
                            }
    ...
    "TIME": function() {
        ...
        try {
            ...
            //计算
            var time = dayjs().set('hour', hour).set('minute', minute).set('second', second);
    ...
    "NETWORKDAYS": function() {
        ...
        try {
            if(arguments.length == 3){
                var result = luckysheet_function.NETWORKDAYS_INTL.f(arguments[0], arguments[1], 1, arguments[2]);
            }
            else{
                var result = luckysheet_function.NETWORKDAYS_INTL.f(arguments[0], arguments[1], 1);
            }
    ...
    "DB": function() {
        ...
        try {
            ...
            //计算
            var rate : any = (1 - Math.pow(salvage / cost, 1 / life)).toFixed(3);

            var initial : any = cost * rate * month / 12;
            ...
            if (period === 1) {
                ...
                var result : any = (cost - total) * rate;
            }
            else {
    ...
    "CUMPRINC": function() {
        ...
        try {
            ...
            //计算
            var payment = luckysheet_function.PMT.f(rate, nper, pv, 0, type);
            var principal = 0;
            ...
            for (var i : number = start_period; i <= end_period; i++) {
                if (type > 0) {
                    principal += payment - (luckysheet_function.FV.f(rate, i - 2, payment, pv, 1) - payment) * rate;
                }
                else {
                    principal += payment - luckysheet_function.FV.f(rate, i - 1, payment, pv, 0) * rate;
                }
            }
        ...
        try {
            ...
            var irrResult = function(values, dates, rate) {
                ...
                for (var i = 1; i < values.length; i++) {
                    result += values[i] / Math.pow(r, luckysheet_function.DAYS.f(dates[i], dates[0]) / 365);
                }
            ...
            var irrResultDeriv = function(values, dates, rate) {
                ...
                for (var i = 1; i < values.length; i++) {
                    var frac = luckysheet_function.DAYS.f(dates[i], dates[0]) / 365;
    ...
    "MIRR": function() {
        ...
        try {
            ...
            var num = -luckysheet_function.NPV.f(reinvest_rate, incomes) * Math.pow(1 + reinvest_rate, n - 1);
            var den = luckysheet_function.NPV.f(finance_rate, payments) * (1 + finance_rate);
    ...
    "XNPV": function() {
        ...
        try {
            ...
            var result = 0;
            for (var i = 0; i < values_n.length; i++) {
                result += values_n[i] / Math.pow(1 + rate, luckysheet_function.DAYS.f(dates[i], dates[0]) / 365);
            }
    ...
    "CUMIPMT": function() {
        ...
        try {
            ...
            for (var i : number = start_period; i <= end_period; i++) {
                if (type === 1) {
                    interest += luckysheet_function.FV.f(rate, i - 2, payment, pv, 1) - payment;
                }
                else {
                    interest += luckysheet_function.FV.f(rate, i - 1, payment, pv, 0);
                }
            }
    ...
    "IPMT": function() {
        ...
        try {
            ...
            //计算
            var payment = luckysheet_function.PMT.f(rate, nper, pv, fv, type);
            var interest;
            ...
            if (per === 1) {
                ...
                if (type === 1) {
                    interest = luckysheet_function.FV.f(rate, per - 2, payment, pv, 1) - payment;
                }
                else {
                    interest = luckysheet_function.FV.f(rate, per - 1, payment, pv, 0);
                }
            }
    ...
    "PPMT": function() {
        ...
        try {
            ...
            //计算
            var payment = luckysheet_function.PMT.f(rate, nper, pv, fv, type);
            var payment2 = luckysheet_function.IPMT.f(rate, per, nper, pv, fv, type);
    ...
    "IMCONJUGATE": function() {
        ...
        try {
            ...
            var x = luckysheet_function.IMREAL.f(inumber);
            if(valueIsError(x)){
                return x;
            }

            var y = luckysheet_function.IMAGINARY.f(inumber);
            if(valueIsError(y)){
                return y;
            }
            ...
            return (y !== 0) ? luckysheet_function.COMPLEX.f(x, -y, unit) : inumber;
        }
        catch (e) {
            var err = e;
            err = formula.errorInfo(err);
    ...
    "IMABS": function() {
        ...
        try {
            var x = luckysheet_function.IMREAL.f(arguments[0]);
            if(valueIsError(x)){
                return x;
            }

            var y = luckysheet_function.IMAGINARY.f(arguments[0]);
            if(valueIsError(y)){
                return y;
            }
    ...
    "IMSUM": function() {
        ...
        try {
            ...
            for(var i = 1; i < arguments.length; i++){
                var a = luckysheet_function.IMREAL.f(result);
                if(valueIsError(a)){
                    return a;
                }

                var b = luckysheet_function.IMAGINARY.f(result);
                if(valueIsError(b)){
                    return b;
                }

                var c = luckysheet_function.IMREAL.f(arguments[i]);
                if(valueIsError(c)){
                    return c;
                }

                var d = luckysheet_function.IMAGINARY.f(arguments[i]);
                if(valueIsError(d)){
                    return d;
                }

                result = luckysheet_function.COMPLEX.f(a + c, b + d);
            }
    ...
    "IMSUB": function() {
        ...
        try {
            ...
            var a = luckysheet_function.IMREAL.f(inumber1);
            if(valueIsError(a)){
                return a;
            }

            var b = luckysheet_function.IMAGINARY.f(inumber1);
            if(valueIsError(b)){
                return b;
            }
            ...
            var c = luckysheet_function.IMREAL.f(inumber2);
            if(valueIsError(c)){
                return c;
            }

            var d = luckysheet_function.IMAGINARY.f(inumber2);
            if(valueIsError(d)){
                return d;
            }
            ...
            return luckysheet_function.COMPLEX.f(a - c, b - d, unit);
        }
        catch (e) {
            var err = e;
            err = formula.errorInfo(err);
    ...
    "IMPRODUCT": function() {
        ...
        try {
            ...
            for(var i = 1; i < arguments.length; i++){
                ...
                result = luckysheet_function.COMPLEX.f(a * c - b * d, a * d + b * c);
            }
    ...
    "IMDIV": function() {
        ...
        try {
            ...
            return luckysheet_function.COMPLEX.f((a * c + b * d) / den, (b * c - a * d) / den, unit);
        }
        catch (e) {
            var err = e;
            err = formula.errorInfo(err);
    ...
    "CELL": function() {
        ...
        try {
            ...
            let value;
            if(formula.execFunctionGlobalData != null && formula.execFunctionGlobalData[row_index+"_"+col_index+"_"+global['index']]!=null){
                value = formula.execFunctionGlobalData[row_index+"_"+col_index+"_"+global['index']].v;
            }
    ...
    "DMIN": function() {
        ...
        try {
            ...
            if (getObjType(field) === "string") {
                var index : any = func_methods.findResultIndex(database, field);
                targetFields = func_methods.rest(database[index]);
            }
            else {
                targetFields = func_methods.rest(database[field]);
    ...
    "DCOUNT": function() {
        ...
        try {
            ...
            return luckysheet_function.COUNT.f.apply(luckysheet_function.COUNT, targetValues);
        }
        catch (e) {
            var err = e;
            err = formula.errorInfo(err);
    ...
    "DCOUNTA": function() {
        ...
        try {
            ...
            return luckysheet_function.COUNTA.f.apply(luckysheet_function.COUNTA, targetValues);
        }
        catch (e) {
            var err = e;
            err = formula.errorInfo(err);
    ...
    "DSTDEV": function() {
        ...
        try {
            ...
            return luckysheet_function.STDEVA.f.apply(luckysheet_function.STDEVA, targetValues);
        }
        catch (e) {
            var err = e;
            err = formula.errorInfo(err);
    ...
    "DSTDEVP": function() {
        ...
        try {
            ...
            return luckysheet_function.STDEVP.f.apply(luckysheet_function.STDEVP, targetValues);
        }
        catch (e) {
            var err = e;
            err = formula.errorInfo(err);
    ...
    "DVAR": function() {
        ...
        try {
            ...
            return luckysheet_function.VAR_S.f.apply(luckysheet_function.VAR_S, targetValues);
        }
        catch (e) {
            var err = e;
            err = formula.errorInfo(err);
    ...
    "DVARP": function() {
        ...
        try {
            ...
            return luckysheet_function.VAR_P.f.apply(luckysheet_function.VAR_P, targetValues);
        }
        catch (e) {
            var err = e;
            err = formula.errorInfo(err);
    ...
    "EVALUATE": function() {
        ...
        try {
            var cell_r = 0;
            var cell_c = 0;
            var sheetindex_now = global['index'];
            //公式文本
