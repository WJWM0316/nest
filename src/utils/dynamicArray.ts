...
function dynamicArrayCompute(dynamicArray) {
    ...
    if(getObjType(dynamicArray) == "array"){
        for(let i = 0; i < dynamicArray.length; i++){
            ...
            if(global['sheet'].data[d_row][d_col] != null && global['sheet'].data[d_row][d_col].f != null && global['sheet'].data[d_row][d_col].f == d_f){
                ...
                if(dynamicArrayRangeIsAllNull({ "row": [d_row, d_row + d_rowlen - 1], "column": [d_col, d_col + d_collen - 1] }, global['sheet'].data)){
...
function dynamicArrayHightShow(r, c) {
    let dynamicArray = global['sheet'][global['index']]["dynamicArray"] == null ? [] : global['sheet'][global['index']]["dynamicArray"];
    ...
    if((r + "_" + c) in dynamicArray_compute && dynamicArray_compute[r + "_" + c].v != "#SPILL!"){
        ...
        let d_f = global['sheet'].data[d_row][d_col].f;
