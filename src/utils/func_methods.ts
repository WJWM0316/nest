import { getObjType, isRealNum, isRealNull, valueIsError } from './utils';
...
const func_methods = {
    ...
    //获取单个单元格数据，数组第一个值
    getFirstValue: function(data, nullCellType = null){
        let _this = this;
    ...
    feb29Between: function(date1, date2){
        ...
        let mar1year1 = dayjs().set('year', year1);
        mar1year1 = dayjs().set('month', 2);
        mar1year1 = dayjs().set('date', 1);
        ...
        let mar1year2 = dayjs().set('year', year2);
        mar1year2 = dayjs().set('month', 2);
        mar1year2 = dayjs().set('date', 1);
